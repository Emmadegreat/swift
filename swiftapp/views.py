...
def export_excel(request):
    ...
    for user in useritems:
        ...
        ws.write(row_num, 10, user.red_oil, font_style)
        ws.write(row_num, 11, user.veg_oil,font_style)

        ws.write(row_num, 12, user.onions_big_size, font_style)
        ws.write(row_num, 13, user.onions_gen_size, font_style)
        #ws.write(row_num, 14, user.aunty_b_spag, font_style)
        #ws.write(row_num, 15, user.g_penny_spag, font_style)
        #ws.write(row_num, 16, user.crown_spag, font_style)
        #ws.write(row_num, 17, user.dangote_spag, font_style)
        #ws.write(row_num, 18, user.indomie_oriental, font_style)
        #ws.write(row_num, 19, user.indomie_chicken, font_style)
        #ws.write(row_num, 20, user.chikki_noodles, font_style)
        #ws.write(row_num, 21, user.mimee_noodles, font_style)
