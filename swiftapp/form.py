...
class UserItemForm(forms.ModelForm):
    ...
    onions_gen_size = forms.ChoiceField(label="Onions-gen-size", choices=onions_list, widget=forms.Select(attrs={'class':'form-control'}))
    ...
    crown_spag = forms.ChoiceField(label="Crown-spag",choices=spaghetti_list, widget=forms.Select(attrs={'class':'form-control'}))
    dangote_spag = forms.ChoiceField(label="Dangote-spag",choices=spaghetti_list, widget=forms.Select(attrs={'class':'form-control'}))
